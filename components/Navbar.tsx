    ...
    <nav className="bg-gradient-to-r from-blue-500 to-purple-600 shadow-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center space-x-4">
          ...
          <Link href="/profile" className="px-4 py-2 bg-white text-blue-600 rounded-md hover:bg-gray-200 transition duration-300">
            Profile
          </Link>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link href="/profile" className="block px-3 py-2 rounded-md text-base font-medium text-blue-600 bg-white hover:bg-gray-200 transition duration-300">
              Profile
            </Link>
          </div>
        </div>
